...
\fixme{nepotrebujeme k tomu predpoklad ze je to MD konstrukcia?}
Celkový čas bude tiež $O(2^{k/2 + n/2})$.\fixme{preco cas dokopy na
vsetkych urovniach je rovnaky ako na jednej? nechyba pred $2^{n/2}$
hodnota $k$ ?}
