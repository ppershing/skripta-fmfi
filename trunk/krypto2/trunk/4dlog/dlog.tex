...
Algoritmus na subexponencialnu zlozitost
...
V prípade eliptických kriviek sa nedá použiť.

Uvažujme $G=(Z_p^*,\cdot)$.
Algoritmus má 2 kroky - predvýpočet a samotný výpočet.
Predvýpočet sa môže spraviť raz pre jednu grupu.

$a \inr Z_{p-1}$. Majme zvolenú prvočíselnú bázu
$B=\{p_1,\dots,p_b\}$. Našou snahou je rozložiť
$g^x$ nad bázou $B$, teda nájsť hodnoty
...
\begin{poznamka}
    Nad GF tvoria bazu ireducibilne polynomy.
\end{poznamka}
\begin{poznamka}
    Ak G je podgrupa Zp*, |G|=q.
