...
\begin{dokaz}
    ...
    Ďalej definujeme $\mathcal{B} \{ S \mid S \subseteq \mathscr{S}, T \union S
    ...
    \mathcal{B}, S' \mbox{ je konečná}, S' \subseteq S$$
     ...
     Potrebujeme ukázať, že $\mathscr{S} \subseteq \mathcal{B}\times\mathcal{B}$ je čiastočné usporiadanie, čiže je
