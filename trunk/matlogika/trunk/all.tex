...
\begin{dokaz}
    Nech $A_1, A_2, \ldots A_n$ je odvodenie (dókaz) formuly $A$
...
\fixme{nasledujuca lema je ta ista ako predchadzajuca}
\begin{lema}
    Ak $T$ je úplná a Henkinova teória, tak potom $T$ má model.
\end{lema}    
\begin{dokaz}
...
\begin{dokaz}
    ...
    \end{equation*}
\end{dokaz} \fixme{je to koniec dokazu?}
