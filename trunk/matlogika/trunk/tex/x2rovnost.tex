...
\begin{itemize}
    ...
    \item[ii)] Zámena termov prebieha len v atomických podformulách
        ...
        \fixme{Naozaj ut mozeme pouzivat VD? Toman jednoducho
        prehlasi, ze je predpoklad $\provable r_1=r_2$ co mi neni
        jasne ze preco by mal byt}
            %%% {{{
            \begin{itemize}
            \item[$\Rightarrow:$]
                \begin{itemize}
...
\begin{dokaz}
    ...
    \begin{itemize}
        \item[i),ii)] Ak $t_1,\dots,t_n,s_1,\dots,s_n$ neobsahujú
            ...
            \fixme{To co tu melie, funguje to? Ak hej, tak mi niekto
            vysvetlite ako tam pouzijem tu vetu o konstantach, som
            zvedavy}
        \item[iii)]
            %%% {{{
            \begin{itemize}
